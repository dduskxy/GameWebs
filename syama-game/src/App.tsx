...
const GAME_DATA: Question[] = [
  {
    ...
    choices: [
      { id: "1a", text: "ออกไปตามหาหมอเทวดาในป่าลึกเพื่อมารักษาพ่อแม่ทันที", isCorrect: false },
      { id: "1b", text: "ปรนนิบัติจัดหาอาหารและตักน้ำดูแลพ่อแม่ด้วยความกตัญญู", isCorrect: true },
      { id: "1c", text: "อธิษฐานขอพรจากเทพยดาให้ดวงตาของพ่อแม่กลับมามองเห็น", isCorrect: false },
    ],
    storyCutscene: {
      ...
      image: `${BASE}scene_1_parents.jpg`,
  ...
  },
  {
    ...
    choices: [
      { id: "2a", text: "ฝึกฝนสมาธิกับบรรดาฤๅษีเพื่อหาทางรักษาดวงตาให้พ่อแม่", isCorrect: false },
      { id: "2b", text: "ปลูกพรรณไม้สมุนไพรหายากรอบอาศรมเพื่อปรุงยาแก้พิษ", isCorrect: false },
      { id: "2c", text: "หาผลไม้และตักน้ำมาให้พ่อแม่โดยมีเหล่าสัตว์ป่าเดินห้อมล้อม", isCorrect: true },
    ],
    storyCutscene: {
      ...
      image: `${BASE}scene_2_water_deer.jpg`,
  ...
  },
  {
    ...
    choices: [
      { id: "3a", text: "พระราชาเล็งเห็นกวางป่า แต่ลูกธนูพลาดไปโดนสุวรรณสาม", isCorrect: false },
      { id: "3b", text: "พระราชาเข้าใจผิดคิดว่าสุวรรณสามเป็นภูตผีหรือสัตว์ลึกลับจึงยิงศรอาบพิษใส่", isCorrect: true },
      { id: "3c", text: "พระราชาพิโรธที่สุวรรณสามทำให้ฝูงกวางตกใจตื่นหนีไป", isCorrect: false },
    ],
    storyCutscene: {
  ...
  },
  {
    ...
    choices: [
      { id: "4a", text: "ตกพระทัยและรีบเสด็จกลับเมืองเพื่อส่งหมอหลวงมารักษา", isCorrect: false },
      { id: "4b", text: "ขอพระราชทานอภัยโทษจากเทพารักษ์และสร้างศาลเพียงตาเพื่อไถ่บาป", isCorrect: false },
      { id: "4c", text: "โทมนัสอย่างยิ่งและตั้งสัตย์ปฏิญาณว่าจะดูแลพ่อแม่ของสุวรรณสามแทน", isCorrect: true },
    ],
    storyCutscene: {
      ...
      image: `${BASE}scene_4_king_remorse.jpg`,
  ...
  },
  {
    ...
    choices: [
      { id: "5a", text: "นางเมขลาปรากฏกายขึ้นมามอบยาวิเศษให้สุวรรณสามดื่มจนฟื้นคืนชีพ", isCorrect: false },
      { id: "5b", text: "พิษศรเสื่อมสลายไป สุวรรณสามฟื้นชีพ และดวงตาของพ่อแม่กลับมาสว่างไสว", isCorrect: true },
      { id: "5c", text: "พระราชาทรงชุบชีวิตสุวรรณสามด้วยน้ำอมฤตจากสวรรค์ชั้นดาวดึงส์", isCorrect: false },
    ],
    storyCutscene: {
      ...
      image: `${BASE}scene_5_miracle.jpg`,
